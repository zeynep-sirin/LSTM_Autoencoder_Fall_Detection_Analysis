...
Elbette, bir önceki yanıtta hazırlanan tüm içeriği, **tablo kullanmadan**, sadece madde işaretleri ve kalınlaştırma ile biçimlendirilmiş profesyonel bir **README.md** dosyası formatında İngilizce olarak sunuyorum.
